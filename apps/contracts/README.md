# color-match-rush - Smart Contracts

This directory contains the smart contracts for color-match-rush, built with Hardhat and optimized for the Celo blockchain.
